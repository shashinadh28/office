...
const TransformBusinessSection = () => {
  return (
    <section className={`${lexend.className} py-16 md:py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white`}>
      <div className="container mx-auto px-6 text-center">
        ...
        >
          Transform Your Business with <span className="text-yellow-300">Optimized SaaS Solutions</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <Link href="/contact-us?service=saas-assessment" passHref legacyBehavior>
            <a
