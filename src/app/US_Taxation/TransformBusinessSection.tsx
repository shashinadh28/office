...
const TransformBusinessSection = () => {
  return (
    <section className={`${lexend.className} py-16 md:py-24 bg-gradient-to-r from-blue-600 to-red-600 text-white`}>
      <div className="container mx-auto px-6 text-center">
        ...
        >
          Transform Your Business with <span className="text-white">Optimized US Taxation Solutions</span>
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <span className="text-lg font-semibold">Let's discuss how we can optimize your tax strategy!</span>
        </motion.div>
